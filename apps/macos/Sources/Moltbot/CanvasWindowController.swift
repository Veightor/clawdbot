          ...
          try {
            ...
            globalThis.addEventListener('a2uiaction', (evt) => {
              try {
                ...
                const handler = globalThis.webkit?.messageHandlers?.moltbotCanvasA2UIAction;
                ...
                const hasBundledA2UIHost = !!globalThis.moltbotA2UI || !!document.querySelector('moltbot-a2ui-host');
