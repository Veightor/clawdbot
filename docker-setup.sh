...
mkdir -p "${MOLTBOT_CONFIG_DIR:-$HOME/.moltbot}"
mkdir -p "${MOLTBOT_WORKSPACE_DIR:-$HOME/clawd}"

export MOLTBOT_CONFIG_DIR="${MOLTBOT_CONFIG_DIR:-$HOME/.moltbot}"
export MOLTBOT_WORKSPACE_DIR="${MOLTBOT_WORKSPACE_DIR:-$HOME/clawd}"
